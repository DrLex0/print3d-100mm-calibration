...
G1 X0 Y0 F8400; center the (left) nozzle
G1 F6000; try in vain to set speed for tool change. It's actually the next G1 command that determines the speed.
T1; switch to left extruder
G4 P0; flush pipeline
G1 X40 Y-40 F6000; I still don't understand the tool change behavior. Sailfish is supposed to combine it with a travel move, but I have never seen this work.
